      ...
      <div class="flex gap-2 container">
        <div class="dropdown">
          ...
          <div class="options">
            ...
            <label style="--index: 1" for="radio-africa">Community</label>
        ...
        <div class="dropdown">
          ...
          <div class="options">
            <input id="radio-africa" type="radio" name="region" value="africa" checked>
            <label style="--index: 1" for="radio-africa">City</label>
        ...
        <div class="dropdown">
          ...
          <div class="options">
            <input id="radio-africa" type="radio" name="region" value="africa" checked>
            <label style="--index: 1" for="radio-africa">Type</label>
        ...
        <div class="dropdown">
          ...
          <div class="options">
            <input id="radio-africa" type="radio" name="region" value="africa" checked>
            <label style="--index: 1" for="radio-africa">Buy/Rent</label>
        ...
        <div class="dropdown">
          ...
          <div class="options">
            <input id="radio-africa" type="radio" name="region" value="africa" checked>
            <label style="--index: 1" for="radio-africa">Beds</label>
        ...
        <div class="dropdown">
          ...
          <div class="options">
            <input id="radio-africa" type="radio" name="region" value="africa" checked>
            <label style="--index: 1" for="radio-africa">Baths</label>
        ...
        <div class="dropdown">
          ...
          <div class="options">
            <input id="radio-africa" type="radio" name="region" value="africa" checked>
            <label style="--index: 1" for="radio-africa">Sq.Ft.</label>
